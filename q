commit 3e11f6bf4efdeec63482435b4e759cebe3e0616f
Author: Reza <reza@Monster.(none)>
Date:   Thu Oct 3 23:10:34 2013 -0700

    first version of filtering and smoothing stickleback track files, only top part is cleaned

diff --git a/filterAndSmoothSticklebackPositionTrack.r b/filterAndSmoothSticklebackPositionTrack.r
new file mode 100644
index 0000000..03cf7d5
--- /dev/null
+++ b/filterAndSmoothSticklebackPositionTrack.r
@@ -0,0 +1,222 @@
